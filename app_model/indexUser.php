    ...
    value * 100
                ...
                <div class="row mt-5 ">
                    <div class="col-md-12 col-lg-6 pt-5">
                        ...
                        <table>
                            <th style="font-size: 15px;">
                                <h3>Here is your train speed</h3>
                            </th>
                    ...
                    <div class="col-md-12 col-lg-6 pt-5">
                        ...
                        <table>
                            <th style="font-size: 15px;">
                                <h3>Estimated arrival time for
                                    <?PHP echo $firstname; ?> (hrs.)
                                </h3>
                            </th>
                            <tr>

                                <td style="font-size: 30px;">
                                    <font style="color:red;size:20px" id="values_t">6.30 PM</font>
                                    <font style="color:Green;size:20px" id="values_tdes"><b>Waiting</b></font>
                                </td>
                ...
                <div class="blas">
                    <li class="wicked"><b>Next arriving station</b></li>
                    <li class="mullet">
                        <h2>Veyangoda</h2>
                    </li>
                    <li class="see">
                    ...
                    <li class="com"><a href="#">PM</a></li>
                </div>

            </div>
            <div class="loc-bottom">
                <h3>Delays and notices</h3>
                <p>Train will getting delay based on teh road condition and the weather </p>
                <div class="air">
                    <li class="wicked">Temperature</li>
                    <li class="mullet" id="tempe">32C</li>

                </div>
                <div class="ball">
                    <li class="wicked">Singnal delay</li>
                    <li class="mullet">Signal delay between Gampaha and Veyangoda stations</li>
