...
<?php
   ...
   if ( isset($_SERVER['REQUEST_METHOD']) && $_SERVER['REQUEST_METHOD'] == 'POST') {
      if(isset($_POST['name']) &&($_POST['name']!="" && $_POST['password']!="")){
        ...
        $sql = "SELECT `id` FROM `admin_details` WHERE `user_name`='$name' and `password`='$password'";
...
<body>
    ...
    <div class="box">
        ...
        <div class="page">
            <div class="header">
                <a id="login" class="active" href="#login">admin log in</a><br><br>
            ...
            <div class="content">
                <form class="login" name="loginForm" onsubmit="return validateLoginForm()" method="POST"
                    ...
                    <div class="row">
                    <div class="col-6 ">
                        <a style="font-size:15px"href="../logIn.php">Not an Admin?</a>
                        </div>
                        <br>
